...
class Basic(ApplicationMethod):
    ...
    def process(self,classificador):
        ...
        print("Correct classification Logistic(Basic) ", part * 100, "%: ", classificador.score())
        print("Correct classification Logistic(Basic) ", part * 100, "%: ", classificador.calculateError())
